(self.webpackChunksporrthub=self.webpackChunksporrthub||[]).push([[2544],{4644:(H,L,o)=>{"use strict";o.d(L,{V:()=>P});var e=o(37919),E=o(40464);const P=(b={},O={})=>{const{id:A,...x}=b,{get:v}=(0,e.kY)();if(!A&&(O?.enabled===void 0||O?.enabled))throw new Error('"id" is a required argument');const{data:M,error:W,isError:a,isLoading:B,refetch:p}=(0,E.useQuery)(["roles",A,"permissions",x],async()=>{const{data:{data:S}}=await v(`/admin/roles/${A}/permissions`,{params:x});return S},O);return{permissions:M,error:W,isError:a,isLoading:B,refetch:p}}},51754:(H,L,o)=>{"use strict";o.d(L,{F:()=>b});var e=o(37919),E=o(61020),P=o(40464);const b=(O={},A={})=>{const{id:x="",...v}=O,{get:M}=(0,e.kY)(),{locale:W}=(0,E.Z)(),a=(0,e.Xe)(W,{sensitivity:"base"}),{data:B,error:p,isError:S,isLoading:F,refetch:g}=(0,P.useQuery)(["roles",x,v],async()=>{const{data:V}=await M(`/admin/roles/${x??""}`,{params:v});return V},A);let y=[];return x&&B?y=[B.data]:Array.isArray(B?.data)&&(y=B.data),{roles:y.sort((V,oe)=>a.compare(V.name,oe.name)),error:p,isError:S,isLoading:F,refetch:g}}},25545:(H,L,o)=>{"use strict";o.r(L),o.d(L,{CreatePage:()=>Re,default:()=>Se});var e=o(27279),E=o(65e3),P=o(42925),b=o(33110),O=o(6854),A=o(35750),x=o(68263),v=o(19915),M=o(86049),W=o(25667),a=o(54095),B=o(60910),p=o(37919),S=o(97367),F=o(84260),g=o(71563),y=o(10124),V=o.n(y),oe=o(61020),ce=o(49402),re=o(51447),C=o(72450),me=o(4644),X=o(36364),G=o(442),_=o(90065),Ce=o(47853);const xe=Ce.Ry().shape({name:Ce.Z_().required(p.I0.required),description:Ce.Z_().required(p.I0.required)}),ae=C.ZP.div`
...
`,B=({children:p,disabled:S=!1,error:F,expanded:g=!1,hasErrorMessage:y=!0,id:V,onToggle:oe,toggle:ce,size:re="M",variant:C="primary",shadow:me})=>{const X=(0,O.M)(V),G=E.useMemo(()=>({expanded:g,onToggle:oe,toggle:ce,id:X,size:re,variant:C,disabled:S}),[S,g,X,oe,re,ce,C]);return(0,e.jsxs)(b.S.Provider,{value:G,children:[(0,e.jsx)(a,{"data-strapi-expanded":g,disabled:S,"aria-disabled":S,expanded:g,hasRadius:!0,variant:C,error:F,shadow:me,children:p}),F&&y&&(0,e.jsx)(v.x,{paddingTop:1,children:(0,e.jsx)(A.Z,{variant:"pi",textColor:"danger600",children:F})})]})}},3667:(H,L,o)=>{"use strict";o.d(L,{v:()=>b});var e=o(74081),E=o(34803),P=o(68263);const b=({children:O,...A})=>{const{expanded:x,id:v}=(0,E.A)();if(!x)return null;const M=`accordion-content-${v}`,W=`accordion-label-${v}`,a=`accordion-desc-${v}`;return(0,e.jsx)(P.x,{role:"region",id:M,"aria-labelledby":W,"aria-describedby":a,...A,children:O})}},34803:(H,L,o)=>{"use strict";o.d(L,{A:()=>P,S:()=>E});var e=o(27279);const E=(0,e.createContext)({disabled:!1,expanded:!1,id:"",size:"M",variant:"primary"}),P=()=>(0,e.useContext)(E)},68809:(H,L,o)=>{"use strict";o.d(L,{B:()=>p});var e=o(74081),E=o(27870),P=o(72450),b=o(59438),O=o(34803);const A=({expanded:S,disabled:F,variant:g})=>{let y="neutral100";return S?y="primary100":F?y="neutral150":g==="primary"&&(y="neutral0"),y};var x=o(56953),v=o(24204),M=o(33110),W=o(19915);const a=(0,P.ZP)(x.A)`
  text-align: left;
